...
trait HasTransformer
{
     ...
     * @return JsonResponse
     */
    public function httpUnauthorized(string $message = null)
    {
        return $this->error(JsonResponse::HTTP_UNAUTHORIZED, $message)
            ->respond(JsonResponse::HTTP_UNAUTHORIZED);
    }
     ...
     * @return JsonResponse
     */
    public function httpForbidden(string $message = null)
    {
        return $this->error(JsonResponse::HTTP_FORBIDDEN, $message)
            ->respond(JsonResponse::HTTP_FORBIDDEN);
    }
